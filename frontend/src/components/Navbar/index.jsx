        ...
        <div className=' h-24 px-10 w-screen pt-3 sticky top-0 z-50 '>
            ...
            >
                <div className="flex justify-between items-center py-4 h-full relative ">
                    <Link to="/" className="flex items-center space-x-2 bg-zinc-300/50  px-3 ml-4 rounded-full py-2 backdrop-blur-3xl">
                    ...
                    <div className='bg-transparent  flex  rounded-3xl  justify-between items-center  '>
                        <ul className="flex space-x-8 text-3xl font-semibold text-[#2c2c2c] px-4 rounded-full  items-center justify-between   backdrop-blur-md" ref={menuRef}>
    ...
    return(
        <div className='flex flex-col items-center justify-center'>
            ...
            <div className='absolute text-lg right-0 top-10'>
                <div className={`bg-white ${!showmenu ? "w-0 h-0 ": "w-40 h-24  border-2 border-black"} flex flex-col justify-between items-center rounded-3xl shadow-lg overflow-hidden duration-300 `}>
                    <ul>
                        <li>
                            <Link to={"user"}>
                            Profile</Link>
